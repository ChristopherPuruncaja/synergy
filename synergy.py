...
def data_parser():
    ...
    try:
        ...
        device_info = f"""{Y}[!] Información del dispositivo :{W}

{G}[+] {C}Sistema Operativo : {W}{var_os}
{G}[+] {C}Plataforma        : {W}{var_platform}
{G}[+] {C}Núcleos de CPU    : {W}{var_cores}
{G}[+] {C}RAM               : {W}{var_ram}
{G}[+] {C}Proveedor de GPU  : {W}{var_vendor}
{G}[+] {C}GPU               : {W}{var_render}
{G}[+] {C}Resolución        : {W}{var_res}
{G}[+] {C}Navegador         : {W}{var_browser}
{G}[+] {C}IP Pública        : {W}{var_ip}
"""
        ...
        if ip_address(var_ip).is_private:
            ...
            if s_code == 200:
                ...
                ip_info = f"""{Y}[!] Información de IP :{W}

{G}[+] {C}Continente  : {W}{var_continent}
{G}[+] {C}País        : {W}{var_country}
{G}[+] {C}Región      : {W}{var_region}
{G}[+] {C}Ciudad      : {W}{var_city}
{G}[+] {C}Organización: {W}{var_org}
{G}[+] {C}ISP         : {W}{var_isp}
"""
                utils.print(ip_info)
    ...
    with open(RESULT, 'r') as result_file:
        ...
        try:
            ...
            if status == 'success':
                ...
                loc_info = f"""{Y}[!] Información de ubicación :{W}

{G}[+] {C}Latitud  : {W}{var_lat}
{G}[+] {C}Longitud : {W}{var_lon}
{G}[+] {C}Precisión: {W}{var_acc}
{G}[+] {C}Altitud  : {W}{var_alt}
{G}[+] {C}Dirección: {W}{var_dir}
